// AUTO-GENERATED by _gen_script.py — DO NOT EDIT MANUALLY
...
export type AnimEvent =
  ...
  | 'commons.body5.s3'
  | 'axis.body5.center'
  | 'axislabel.body5.diff'
  | 'axislabel.body5.auto'
  | 'pulse.body5.frames'
  | 'extras.body5.in'
  | 'scene.outro.in'
  | 'cat.outro.in'
...
export const SCRIPT: ScriptLine[] = [
  ...
  { speaker: 'めたん', text: 'プロンプトに「猫の写真」って打つと、本当に猫が出てくるのよ。', event: 'canvas.intro.in' },
  { speaker: 'ずんだもん', text: 'うんうん、出てくるのだ。' },
  { speaker: 'めたん', text: 'あれって、AIが頭の中で完成図を思い浮かべて、ぱっと描いてる感じかしら？', event: 'cat.intro.in' },
  { speaker: 'ずんだもん', text: '実はね、そこが多くの人が誤解してるところなのだ。' },
  { speaker: 'めたん', text: 'あら、違うの？' },
  { speaker: 'ずんだもん', text: '画像生成AIはね、一発で絵を当てることを、最初から諦めてるのだ。', event: 'title.intro.in' },
  ...
  { speaker: 'ずんだもん', text: '主役は二つ。拡散モデルと、自己回帰モデル。', event: 'subcards.intro.in' },
  { speaker: 'めたん', text: '聞いたことはあるわ。Stable DiffusionとかGPT-4oとか。', event: 'labels.intro.in' },
  { speaker: 'ずんだもん', text: 'そのへんで使われてる仕組みなのだ。' },
  { speaker: 'ずんだもん', text: '見た目はぜんぜん違うんだけど、骨組みはほとんど同じ。' },
  { speaker: 'めたん', text: '同じなの？それぞれ別物の発明だと思ってたわ。' },
  { speaker: 'ずんだもん', text: '同じ作戦の、軸違いなのだ。', event: 'sublink.intro.in' },
  { speaker: 'めたん', text: '軸違い。なんだかパズルみたいね。' },
  { speaker: 'ずんだもん', text: '順番に解いていくのだ。' },
  { speaker: 'ずんだもん', text: 'まずは「一発で当てるのが、なぜ無謀なのか」から。' },
  ...
  { speaker: 'ずんだもん', text: 'マスの数は、約100万個。', event: 'grid.body1.in' },
  { speaker: 'めたん', text: '100万のマスね。' },
  { speaker: 'ずんだもん', text: '1マスは、赤・緑・青の三色を混ぜて表現する。' },
  { speaker: 'ずんだもん', text: 'それぞれ256段階あって、1マスで約1600万通りの色が選べるのだ。', event: 'cells.body1.color' },
  { speaker: 'めたん', text: '100万のマスに、それぞれ1600万通り。' },
  { speaker: 'ずんだもん', text: '可能な絵の総数は、もう数字で書く意味がないくらい巨大なのだ。' },
  { speaker: 'めたん', text: '想像つかないわね。', event: 'noise.body1.fill' },
  { speaker: 'ずんだもん', text: 'その膨大な可能性のほとんどは、人間が見ても、ただのザーザーの砂嵐に見える絵。', event: 'haze.body1.in' },
  { speaker: 'めたん', text: 'あら、絵じゃなくて？' },
  { speaker: 'ずんだもん', text: '絵じゃない。完全にランダムな色のマスが並んでるだけ。' },
  { speaker: 'めたん', text: 'そっか、全部の組み合わせの中身は、ほとんど無意味な絵なのね。' },
  { speaker: 'ずんだもん', text: 'その通り。人間が「猫」と認めるパターンは、その大海の中の、ごく小さな点。', event: 'dot.body1.in' },
  { speaker: 'めたん', text: 'ふうん。じゃあ、絵に見える組み合わせを引き当てるのが、難しいってこと？' },
  { speaker: 'ずんだもん', text: '難しい、というか、無謀なのだ。', event: 'tone.body1.down' },
  { speaker: 'ずんだもん', text: '100万マスの色を、全部いっぺんに当てる問題、なのだ。' },
  ...
  { speaker: 'ずんだもん', text: 'だから、画像生成AIは、この戦い方をまず捨てたのだ。' },
  ...
  { speaker: 'ずんだもん', text: '「一発で当てる」を、「易しい一手のくり返し」にバラそう、と。', event: 'beads.body2.in' },
  { speaker: 'めたん', text: '易しい一手。' },
  { speaker: 'ずんだもん', text: 'たとえばこう。完成済みの絵に、ほんの少しだけ手を加える、なら易しいのだ。' },
  { speaker: 'めたん', text: 'ふむふむ。' },
  { speaker: 'ずんだもん', text: '「ほとんど完成」を「もう一歩だけ完成に寄せる」のは、全部当てるよりずっと簡単。' },
  ...
  { speaker: 'ずんだもん', text: 'そう。少しだけ寄せる、を何度も何度もくり返せば、最後には完成にたどり着く。', event: 'beads.body2.light' },
  { speaker: 'めたん', text: '大きな問いを、小さな問いの列に分けたのね。' },
  { speaker: 'ずんだもん', text: 'その通り。一発当ての無謀を、易しい一手の連鎖に置き換えた。', event: 'beads.body2.full' },
  { speaker: 'めたん', text: 'それなら、各ステップは学べそうな気がするわね。' },
  { speaker: 'ずんだもん', text: 'そこが鍵。一発当ては学べないけど、易しい一手なら学べる。' },
  { speaker: 'めたん', text: 'で、その「バラし方」に二通りある、って話だったわよね。' },
  { speaker: 'ずんだもん', text: 'そう。同じ作戦を、別の軸でバラした、二つの仕組みがあるのだ。', event: 'dual.body2.in' },
  { speaker: 'めたん', text: 'その二つ、ちょっと先に教えてもらえる？' },
  { speaker: 'ずんだもん', text: 'まず一つ目。最初の状態は、画面ぜんぶがザーザーの砂嵐から始まる。', event: 'noise.body2.fill' },
  { speaker: 'めたん', text: '完全な砂嵐ね。' },
  { speaker: 'ずんだもん', text: 'そこから、画面全体のザラつきを、少しだけ薄める。', event: 'noise.body2.thin' },
  { speaker: 'ずんだもん', text: 'もう少し薄める。さらに薄める。' },
  { speaker: 'めたん', text: '画面全体が、だんだんはっきりしていくのね。' },
  { speaker: 'ずんだもん', text: '最後にはザラつきが消えて、絵が現れる。これが拡散モデル。', event: 'label.body2.diff' },
  { speaker: 'めたん', text: 'もう一つは？' },
  { speaker: 'ずんだもん', text: 'もう一つは、最初の状態が、何も描かれていない、空っぽのキャンバスから始まる。', event: 'grid.body2.in' },
  { speaker: 'めたん', text: '真っ白ね。' },
  { speaker: 'ずんだもん', text: 'そこに、左上のマスから順に、一マスずつ色を置いていく。', event: 'cells.body2.fill' },
  { speaker: 'めたん', text: 'マスを一個ずつ、順に埋めていくのね。' },
  { speaker: 'ずんだもん', text: '全部埋まれば、絵が完成する。これが自己回帰モデル。', event: 'label.body2.auto' },
  ...
  { speaker: 'ずんだもん', text: 'では、それぞれをじっくり見せていくのだ。' },
  { speaker: 'めたん', text: 'お願い。' },
  { speaker: 'ずんだもん', text: 'まずは拡散モデル。', event: 'scene.body3.in' },
  { speaker: 'めたん', text: 'お願い。' },
  { speaker: 'ずんだもん', text: '絵を作るときは、画面全体が完全な砂嵐から始まる。', event: 'canvas.body3.in' },
  { speaker: 'めたん', text: '色のついた砂粒が、画面いっぱいに敷き詰められてる感じね。' },
  { speaker: 'ずんだもん', text: 'そこから、ノイズをほんの少しだけ引く。', event: 'step.body3.s1' },
  ...
  { speaker: 'ずんだもん', text: 'そんな感じ。次のステップで、もう少しノイズを引く。', event: 'step.body3.s2' },
  { speaker: 'ずんだもん', text: 'また次のステップで、もう少し引く。' },
  { speaker: 'めたん', text: 'だんだん、絵がはっきりしてくるのね。' },
  { speaker: 'ずんだもん', text: 'それを20回とか50回くり返すと、絵が完成する。', event: 'step.body3.s3to5' },
  { speaker: 'めたん', text: '待って。各ステップで「ノイズを少し引く」って、AIはどうやって判断してるの？' },
  { speaker: 'ずんだもん', text: 'いい質問なのだ。秘密は学習のときの仕掛けにある。', event: 'learn.body3.shift' },
  { speaker: 'めたん', text: '仕掛け？' },
  { speaker: 'ずんだもん', text: '学習のときは、逆をやるのだ。完成済みの絵に、ノイズを少しずつ足していく。', event: 'learn.body3.chain' },
  ...
  { speaker: 'めたん', text: 'ふむふむ。' },
  { speaker: 'ずんだもん', text: 'そのペアを大量に集めて、AIに「多い側を見て、少ない側を当てよ」と訓練する。', event: 'learn.body3.pair' },
  { speaker: 'めたん', text: 'あら、それなら答えがちゃんとあるわね。' },
  { speaker: 'ずんだもん', text: '一発当ては答えがないけど、こっちは答えがある。' },
  { speaker: 'めたん', text: '教師ありの問題に化けるのね。', event: 'learn.body3.flip' },
  { speaker: 'ずんだもん', text: 'そう、これが鍵。AIは「答えのある問題」しか学べない。' },
  { speaker: 'めたん', text: '絵を汚す手順を自分で決めたから、汚す前の答えを知ってる、と。' },
  { speaker: 'ずんだもん', text: 'その通り。だから絵を作るときは、足した手順を逆にたどるだけで良い。', event: 'learn.body3.out' },
  { speaker: 'めたん', text: '純粋な砂嵐から、ちょっとずつ綺麗にしていけば、いつか完成にたどり着くのね。', event: 'step.body3.s6to8' },
  { speaker: 'ずんだもん', text: 'これが拡散モデルの正体なのだ。', event: 'axislabel.body3.in' },
  ...
  { speaker: 'めたん', text: 'これを使ってるのが、Stable DiffusionとかMidjourneyとかDALL-Eね。' },
  { speaker: 'ずんだもん', text: 'そう。今の世のお絵かきAIの主流は、ほとんどこの仕組みなのだ。' },
  { speaker: 'ずんだもん', text: '次は、自己回帰モデル。', event: 'scene.body4.in' },
  { speaker: 'めたん', text: 'お願い。' },
  { speaker: 'ずんだもん', text: '絵を作るときは、何も描かれていない、空っぽのキャンバスから始まる。', event: 'canvas.body4.in' },
  { speaker: 'めたん', text: '真っ白ね。' },
  { speaker: 'ずんだもん', text: 'そこで、画像を「パッチ」という小さなマスに区切る。', event: 'grid.body4.in' },
  { speaker: 'めたん', text: 'マスの大きさは？' },
  { speaker: 'ずんだもん', text: '仕組みによるけど、例えば16×16ピクセルが1パッチ。' },
  { speaker: 'めたん', text: '1024の絵だと、縦横64個ずつ、合わせて4096個のパッチね。' },
  { speaker: 'ずんだもん', text: 'そう。そのパッチを、左上から順番に、一つずつ埋めていくのだ。', event: 'cells.body4.first' },
  { speaker: 'めたん', text: '1パッチずつ、順に色を決めていくのね。' },
  { speaker: 'ずんだもん', text: 'そう。各ステップで「次のパッチに何が来るか」を予測する。' },
  { speaker: 'めたん', text: '文章の続きを書くみたいに？', event: 'learn.body4.shift' },
  { speaker: 'ずんだもん', text: 'まさにそれなのだ。GPTが文章を作るときと、まったく同じ仕組み。', event: 'learn.body4.tokens' },
  { speaker: 'めたん', text: 'あら、画像なのに文章と同じ機械でいけるの？' },
  { speaker: 'ずんだもん', text: '画像をパッチの「列」に並べ直せば、文字の列とほとんど同じものになる。', event: 'learn.body4.row' },
  { speaker: 'めたん', text: '列にして並べるんだ。' },
  { speaker: 'ずんだもん', text: '行ごとに左から右、それを上から下へつなげれば、ただの「パッチの並び」になる。' },
  { speaker: 'めたん', text: 'そうすれば、GPTの仕組みがそのまま使えるってこと？' },
  { speaker: 'ずんだもん', text: 'そう。だから、自己回帰モデルでの画像生成は、テキスト生成と全く同じ機械で動かせるのだ。', event: 'learn.body4.frame' },
  { speaker: 'めたん', text: '各ステップは、何を見て、何を予測してるの？' },
  { speaker: 'ずんだもん', text: 'これまで埋めたパッチを全部見て、次の1パッチの中身を当てる。', event: 'learn.body4.out' },
  { speaker: 'めたん', text: 'これも、各ステップは易しい問題ね。' },
  { speaker: 'ずんだもん', text: 'そう。完成全部を一発で当てる問題が、1パッチ当てる問題の列に化ける。', event: 'cells.body4.mid1' },
  { speaker: 'めたん', text: 'これも、学習はどうやってるの？' },
  { speaker: 'ずんだもん', text: '完成された画像を持ってきて、パッチの列に並べる。' },
  { speaker: 'ずんだもん', text: 'そして、「途中までを入力に、その次のパッチを答えに」というペアを大量に作る。', event: 'pair.body4.in' },
  { speaker: 'めたん', text: 'これも教師あり問題に化けるのね。' },
  { speaker: 'ずんだもん', text: 'そう。答えのある問題に変身させてから学ばせる、というところは拡散モデルと同じ。', event: 'cells.body4.mid2' },
  ...
  { speaker: 'ずんだもん', text: 'それを最後まで繰り返せば、絵が完成する。', event: 'cells.body4.full' },
  ...
  { speaker: 'めたん', text: 'あら、ChatGPTのあれも？' },
  { speaker: 'ずんだもん', text: 'そう、ChatGPTで絵を作れる機能の中身が、この仕組み。' },
  { speaker: 'めたん', text: 'テキストと画像が、同じ機械の上で動いてるってことね。' },
  { speaker: 'ずんだもん', text: 'そう、それが自己回帰モデルの大きな強み。', event: 'axislabel.body4.in' },
  ...
  { speaker: 'ずんだもん', text: '見え方は違うのだ。でも、骨組みはほとんど同じ。', event: 'dual.body5.in' },
  { speaker: 'めたん', text: '骨組み？' },
  { speaker: 'ずんだもん', text: '三つの共通点があるのだ。一つずつ並べていく。', event: 'commons.body5.s1' },
  { speaker: 'めたん', text: 'はい。' },
  { speaker: 'ずんだもん', text: '一つ目。両方とも、一発当ての無謀を、易しい一手の連鎖にバラした。' },
  { speaker: 'めたん', text: 'これは共通ね。' },
  { speaker: 'ずんだもん', text: '二つ目。両方とも、その連鎖を「前の状態を見て、次を当てる」という形に揃えた。', event: 'commons.body5.s2' },
  ...
  { speaker: 'ずんだもん', text: '三つ目。両方とも、学習のときに「逆方向」を仕込むことで、答えのある問題に化けさせた。', event: 'commons.body5.s3' },
  ...
  { speaker: 'ずんだもん', text: '違うのは、バラし方の軸、ただ一つだけ。', event: 'axis.body5.center' },
  { speaker: 'めたん', text: '軸。つまり、何にそって分割したか、ってこと？' },
  { speaker: 'ずんだもん', text: 'その通り。' },
  { speaker: 'ずんだもん', text: '拡散モデルは「ノイズの量」を軸にバラした。画面全体のザラつきを段階的に薄める。', event: 'axislabel.body5.diff' },
  { speaker: 'ずんだもん', text: '自己回帰モデルは「空間の位置」を軸にバラした。マスを順番に埋める。', event: 'axislabel.body5.auto' },
  { speaker: 'めたん', text: '同じ作戦を、別の方向で切ってるだけね。' },
  { speaker: 'ずんだもん', text: 'そう。同じ作戦を、別の方向で切ったから、出てくる絵の作られ方が違って見えるだけ。' },
  { speaker: 'めたん', text: '見た目が違うから、別物に見えてただけ、ということね。' },
  { speaker: 'ずんだもん', text: 'そう。中身の発想は、ほとんど同じ。', event: 'pulse.body5.frames' },
  { speaker: 'めたん', text: '軸が違うと、得意なことも変わってくる？' },
  { speaker: 'ずんだもん', text: '少しだけ違ってくる。脇道として触れておくのだ。' },
  { speaker: 'ずんだもん', text: '拡散モデルは、最初から画面全体の構図がぼんやり決まっていく。' },
  ...
  { speaker: 'ずんだもん', text: 'お絵かき特化なら拡散、テキストと混ぜたいなら自己回帰、と棲み分けが進んでる。', event: 'extras.body5.in' },
  { speaker: 'ずんだもん', text: 'ここまで来たら、最初の話に戻れるのだ。', event: 'scene.outro.in' },
  { speaker: 'めたん', text: '最初は「画像生成AIは一発で当てることを諦めてる」って話だったわね。' },
  { speaker: 'ずんだもん', text: '諦めたうえで、易しい一手の連鎖にバラした。', event: 'cat.outro.in' },
  { speaker: 'ずんだもん', text: 'これが、画像生成AIの本当の発明なのだ。', event: 'title.outro.in' },
  ...
  { speaker: 'めたん', text: '拡散モデルと自己回帰モデルは、その「バラし方」の二つの軸なのね。', event: 'subcards.outro.in' },
  { speaker: 'ずんだもん', text: 'そう。違う仕組みに見えるけど、骨は同じ。違うのは軸だけ。' },
  { speaker: 'めたん', text: 'ノイズの軸か、空間の軸か。', event: 'labels.outro.in' },
  { speaker: 'ずんだもん', text: 'そう。これからAIが描いた絵を見るときは、軸を思い浮かべてみるのだ。' },
  { speaker: 'めたん', text: '「これは画面全体が砂嵐から立ち上がってきた絵かしら」「これはマス目を順に埋めて作った絵かしら」って。' },
  { speaker: 'ずんだもん', text: 'そう。中で何が起きてるか、想像が湧くようになる。', event: 'links.outro.in' },
  { speaker: 'めたん', text: '表面の魔法じゃなくて、中の骨組みが見えてくるのね。' },
  { speaker: 'ずんだもん', text: 'それが今日のお土産なのだ。' },
  { speaker: 'めたん', text: 'ありがとう、ずんだもん。' },
  { speaker: 'ずんだもん', text: 'またなのだ。', event: 'tone.outro.down' },
];
