...
export const VideoWithSubtitles: React.FC = () => {
    ...
    const headerTitle = currentEntry?.sceneTitle ?? '暗号化とハッシュ化——似ているようで全く違う';
        ...
        <AbsoluteFill>
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 28 }}>
                    ...
                    <div style={{
                        fontSize: 22, fontWeight: 800, color: '#374151', lineHeight: 1.3,
                        fontFamily: '"Zen Maru Gothic", sans-serif',
                    }}>
                        暗号化とハッシュ化——似ているようで全く違う
                    </div>
                    <div style={{
            ...
            >
                <OffthreadVideo
                    src={staticFile('videos/encryption_vs_hashing.mp4')}
