...
export const Scene10: React.FC = () => (
    ...
    <div className="content center-layout">
        ...
        <div className="code-box">
            ...
            <div className="code-body"><span className="kw">function</span> <span className="fn">getLength</span>(input) {'{'}
  <span className="kw">return</span> input.<span className="err">length</span>;  <span className="cm">// 動くまでエラー不明</span>
{'}'}
<span className="fn">getLength</span>(<span className="str">42</span>);  <span className="cm">// Runtime Error!</span></div>
        </div>
...
export const Scene16: React.FC = () => (
    ...
    <div className="content center-layout">
        ...
        <div className="code-box">
            ...
            <div className="code-body"><span className="kw">type</span> <span className="tp">DeepPartial</span>&lt;T&gt; =
  T <span className="kw">extends</span> Function ? T :
  T <span className="kw">extends</span> Array&lt;<span className="kw">infer</span> U&gt;
    ? _DeepPartialArray&lt;U&gt; :
  T <span className="kw">extends</span> <span className="tp">object</span>
    ? _DeepPartialObject&lt;T&gt; :
  T | <span className="tp">undefined</span>;</div>
        </div>
