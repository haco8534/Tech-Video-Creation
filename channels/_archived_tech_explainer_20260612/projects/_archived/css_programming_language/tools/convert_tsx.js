...
const htmlPath = path.resolve(__dirname, '../../projects/css_programming_language/slides/index.html');
const outputPath = path.resolve(__dirname, '../../projects/css_programming_language/remotion/scenes/SlideScenes.tsx');
