...
const WELL_KNOWN_TERMS = [
    ...
    { surface: 'Tesla', pronunciation: 'テスラ' },
    // Technical Terms
    ...
    { surface: 'SNS', pronunciation: 'エスエヌエス' },
    { surface: 'CM', pronunciation: 'シーエム' },
    ...
    // Programming essence video specific
    { surface: 'ENIAC', pronunciation: 'エニアック' },
    { surface: 'LISP', pronunciation: 'リスプ' },
    { surface: 'ALGOL', pronunciation: 'アルゴル' },
    { surface: 'SICP', pronunciation: 'シックピー' },
    { surface: 'ADD', pronunciation: 'アド' },
    { surface: 'SUB', pronunciation: 'サブ' },
    { surface: 'JUMP', pronunciation: 'ジャンプ' },
    { surface: 'ID', pronunciation: 'アイディー' },
    { surface: 'WHAT', pronunciation: 'ホワット' },
    { surface: 'HOW', pronunciation: 'ハウ' },
    ...
    // internet_governance (proj_ede76869) specific — compounds first, then singles
    { surface: 'Let\'s Encrypt', pronunciation: 'レッツエンクリプト' },
    { surface: 'Wi-Fi 6E', pronunciation: 'ワイファイシックスイー' },
    { surface: 'Wi-Fi', pronunciation: 'ワイファイ' },
    { surface: 'Bluetooth', pronunciation: 'ブルートゥース' },
    { surface: 'ITU', pronunciation: 'アイティーユー' },
    { surface: 'YouTube', pronunciation: 'ユーチューブ' },
    { surface: 'Ethernet', pronunciation: 'イーサネット' },
    { surface: 'Cloudflare', pronunciation: 'クラウドフレア' },
    { surface: 'NTT', pronunciation: 'エヌティーティー' },
    { surface: 'NTIA', pronunciation: 'エヌティーアイエー' },
    { surface: 'IANA', pronunciation: 'アイアナ' },
    { surface: 'ICANN', pronunciation: 'アイキャン' },
    { surface: 'IETF', pronunciation: 'アイイーティーエフ' },
    { surface: 'W3C', pronunciation: 'ダブリューサンシー' },
    { surface: 'ARIN', pronunciation: 'エーリン' },
    { surface: 'RIPE', pronunciation: 'ライプ' },
    { surface: 'APNIC', pronunciation: 'アプニック' },
    { surface: 'JPNIC', pronunciation: 'ジェーピーニック' },
    { surface: 'JPRS', pronunciation: 'ジェーピーアールエス' },
    { surface: 'ISP', pronunciation: 'アイエスピー' },
    { surface: 'RFC', pronunciation: 'アールエフシー' },
    { surface: 'RFC1', pronunciation: 'アールエフシーいち' },
    { surface: 'RAND', pronunciation: 'ランド' },
    { surface: 'RPKI', pronunciation: 'アールピーケーアイ' },
    { surface: 'HTTP', pronunciation: 'エイチティーティーピー' },
    // cache video (proj_c86941a8) specific — compounds first, then singles
    { surface: 'Service Worker', pronunciation: 'サービスワーカー' },
    { surface: 'Cache Storage', pronunciation: 'キャッシュストレージ' },
    { surface: 'Clear data', pronunciation: 'クリアデータ' },
    { surface: 'Clear storage', pronunciation: 'クリアストレージ' },
    { surface: 'slave memory', pronunciation: 'スレイブメモリー' },
    { surface: 'IndexedDB', pronunciation: 'インデックスディービー' },
    { surface: 'localStorage', pronunciation: 'ローカルストレージ' },
    { surface: 'Chrome', pronunciation: 'クローム' },
    { surface: 'Cookie', pronunciation: 'クッキー' },
    { surface: 'CDN', pronunciation: 'シーディーエヌ' },
    { surface: 'Samsung', pronunciation: 'サムスン' },
    { surface: 'VPN', pronunciation: 'ブイピーエヌ' },
    { surface: 'Wilkes', pronunciation: 'ウィルクス' },
    { surface: 'Cache', pronunciation: 'キャッシュ' },
    { surface: 'cache', pronunciation: 'キャッシュ' },
    { surface: 'cacher', pronunciation: 'カシェ' },
    { surface: 'Storage', pronunciation: 'ストレージ' },
    { surface: 'storage', pronunciation: 'ストレージ' },
    { surface: 'Worker', pronunciation: 'ワーカー' },
    { surface: 'Service', pronunciation: 'サービス' },
    { surface: 'Clear', pronunciation: 'クリア' },
    { surface: 'memory', pronunciation: 'メモリー' },
    { surface: 'slave', pronunciation: 'スレイブ' },
    { surface: 'data', pronunciation: 'データ' },
    { surface: 'L1', pronunciation: 'エルワン' },
    { surface: 'L2', pronunciation: 'エルツー' },
    { surface: 'L3', pronunciation: 'エルスリー' },
    { surface: 'GB', pronunciation: 'ギガバイト' },
    { surface: 'IO', pronunciation: 'アイオー' },
    // Cloud video specific
    { surface: 'iCloud', pronunciation: 'アイクラウド' },
    { surface: 'LINE', pronunciation: 'ライン' },
    { surface: 'NIST', pronunciation: 'ニスト' },
    { surface: 'EC2', pronunciation: 'イーシーツー' },
    { surface: 'Azure', pronunciation: 'アジュール' },
    { surface: 'Compute', pronunciation: 'コンピュート' },
    { surface: 'Engine', pronunciation: 'エンジン' },
    { surface: 'Slack', pronunciation: 'スラック' },
    { surface: 'Basecamp', pronunciation: 'ベースキャンプ' },
    { surface: 'Andreessen', pronunciation: 'アンドリーセン' },
    { surface: 'Horowitz', pronunciation: 'ホロウィッツ' },
    { surface: 'VPS', pronunciation: 'ブイピーエス' },
    // proj_614d0f20 algorithm video specific
    { surface: 'Muhammad ibn Musa al-Khwarizmi', pronunciation: 'ムハンマド イブン ムーサ アルフワーリズミー' },
    { surface: 'al-Khwarizmi', pronunciation: 'アルフワーリズミー' },
    { surface: 'Khwarizmi', pronunciation: 'フワーリズミー' },
    { surface: 'Algoritmi', pronunciation: 'アルゴリトミ' },
    { surface: 'algebra', pronunciation: 'アルジェブラ' },
    { surface: 'Euclid', pronunciation: 'ユークリッド' },
    { surface: 'Donald', pronunciation: 'ドナルド' },
    { surface: 'Knuth', pronunciation: 'クヌース' },
    { surface: 'Dijkstra', pronunciation: 'ダイクストラ' },
    { surface: 'Finiteness', pronunciation: 'ファイナイトネス' },
    { surface: 'Definiteness', pronunciation: 'デフィニットネス' },
    { surface: 'Effectiveness', pronunciation: 'エフェクティブネス' },
    { surface: 'Input', pronunciation: 'インプット' },
    { surface: 'Output', pronunciation: 'アウトプット' },
    { surface: 'bubble sort', pronunciation: 'バブルソート' },
    { surface: 'quick sort', pronunciation: 'クイックソート' },
    { surface: 'merge sort', pronunciation: 'マージソート' },
    { surface: 'binary search', pronunciation: 'バイナリサーチ' },
    { surface: 'Big O', pronunciation: 'ビッグオー' },
    { surface: 'RSA', pronunciation: 'アールエスエー' },
    { surface: 'The Art of Computer Programming', pronunciation: 'ザ アート オブ コンピューター プログラミング' },
];
