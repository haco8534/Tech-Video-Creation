...
const htmlPath = path.resolve(__dirname, '../../projects/typescript_savior_or_killer/slides/index.html');
const outputPath = path.resolve(__dirname, '../../projects/typescript_savior_or_killer/remotion/scenes/SlideScenes.tsx');
